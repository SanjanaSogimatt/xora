...
const Header = () => {
    ...
    const NavLink = ({ title }) => (
        <LinkScroll
            ...
            className="based-bold text-p4 uppercase transition-colors duration-300 hover:text-p1 cursor-pointer max-lg:my-4 max-lg:h5"
        >
            {title}
        </LinkScroll>
    )
    return (
        <header className={clsx("fixed left-0 top-0 z-50 w-full py-10",hasScrolled && "py-2 bg-black-100 backdrop-blur-[8px]")}>
                            ...
                            <ul className="flex max-lg:block max-lg:px-12">
                                ...
                                <li className="nav-logo">
                                    <LinkScroll
                                        ...
                                        spy
                                        smooth
                                        className={clsx("max-lg:hidden transition-trnaform duration-500 cursor-pointer")}
                                    >
                                        <img src="/images/xora.svg" width={115} height={55} alt="logo" />
                                    </LinkScroll>
                                </li>
